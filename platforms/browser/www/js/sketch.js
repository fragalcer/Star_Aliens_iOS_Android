...
function preload() {
    ...
    print("hello world!!!");
    myCustomFont = loadFont('js/justice.ttf');
    myArcadeFont = loadFont('js/arcade.ttf');
    laserSound = loadSound('js/laser.wav');
    newRecordSound = loadSound('js/new_record.wav');
    song = loadSound('js/soda_juego.mp3');
}
